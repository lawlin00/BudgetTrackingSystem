...
echo "<td class='text-center col-sm-4'><a class='btn btn-info btn-xs' href = 'AdminEditUser.php?id=$userid' style='padding: 5px 10px'><span class='glyphicon glyphicon-edit'></span>Edit</a></td>";
echo "<td><a href='AdminDeleteUser.php?userid=$userid' class='btn btn-danger btn-xs'style='padding: 5px 10px'  onclick =\"return confirm('Do you really want to remove the member?');\"><span class='glyphicon glyphicon-remove'></span> Del</a></td>";
echo "</tr>";
        }
?>
</table>
