...
//  }
 ...
 $sql = "Update user SET UserEmail = '$Email', User_Birthday = '$Dob' , UserGender = '$Gender' , UserRole = '$Role', UserImg = '$target_file', ";
   ...
   $sql = "Update user SET UserEmail = '$Email', User_Birthday = '$Dob' , UserGender = '$Gender', UserRole = '$Role' ";
