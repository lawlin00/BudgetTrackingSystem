...
<html lang="en">
  ...
  <body class="bg">
      ...
      <div class="navbar navbar-expand-lg navbar-dark bg-dark navbar-custom">
        ...
        <!-- Search form -->
        <h3 class="ml-auto col-sm-9 col text-white text-center justify-content-center" ></h3>
  ...
  <form action="" class="form-container">
    <div class="col-lg-12 marginTop">
            <strong class="col-lg-2">Comment</strong>
            <div class="col-lg-4">
             <textarea rows="5" name="comment" placeholder="Enter text here..." cols="60"></textarea></div>
        </div>
